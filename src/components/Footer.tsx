...
const Footer = () => {
  ...
  // 🔵 POLÍTICA DE PRIVACIDAD (TEXTO LITERAL DE TU WORD)
  const PRIVACY_TEXT = `
...
Automatización inteligente para tu negocio
  ...
  // 🟠 TÉRMINOS Y CONDICIONES (TEXTO LITERAL DE TU WORD)
  const TERMS_TEXT = `
...
________________________________________
  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      ...
      {/* 🔵 Panel con el texto literal incrustado */}
      <FooterLegal
        open={open}
        onClose={() => setOpen(false)}
        content={tab === "privacy" ? PRIVACY_TEXT : TERMS_TEXT}
        title={
          tab === "privacy" ? "Política de Privacidad" : "Términos y Condiciones"
        }
      />
    </footer>
  );
